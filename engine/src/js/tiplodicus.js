;(function ($, window, document, undefined) {
    var pluginName = 'tiplodicus',
        ...
        isTouchDevice = (function () {
            return true == ("ontouchstart" in window || (window.DocumentTouch && document instanceof DocumentTouch) || navigator.maxTouchPoints > 0);
        })(),
        hasPointerEvts = (function () {
            return navigator.pointerEnabled || false;
        })(),
    ...
    Plugin.prototype = {
        init: function () {
            ...
            **/
            ...
            if (isTouchDevice) {
                ...
                /**
                    If it's a touch device and has pointer events the device is MOST LIKELY
                    a Surface or Microsoft tablet. Pointer events are wonky so lets just say
                    it's a click event and leave off the hover events because it fires them
                    at the same time.
                **/
                attachedEvents = hasPointerEvts ? 'click.' : 'touchstart.';

                 attachedEvents += self.options.evtNamespace
            }
            ...
            if (self.$el.html().indexOf(' ') > -1) {
                var text = self.$el.html().match(/<.+?>|\S+/g),
        ...
        destroy: function () {
            ...
            this.$tooltip.remove();
            $(document).off('click.tip-close touchstart.tip-close')
